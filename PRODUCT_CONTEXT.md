...
7. Use the Patient overview **Log missed** action, or `POST /checkins/missed`, when a scheduled call and retry are unanswered; this records the missed attempt and triggers the same schedule, escalation, record, and volunteer-task flow as the demo scenario.
